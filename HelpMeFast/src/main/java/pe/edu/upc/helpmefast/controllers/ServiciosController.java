...
public class ServiciosController {
    ...
    @GetMapping("/reporteFrancis")
    public List<RespuestaFrancis> buscarserviciosenfermero(){return  sService.buscarServiciosEnfermero();}
    @GetMapping("/cantidadFrancis")
    public List<ResultadoFrancis> buscaranunciosdistrito(){
        return sService.buscarAnunciosDistrito();
    }
}
