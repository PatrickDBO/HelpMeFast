...
public class AnuncioController {
    ...
    @PostMapping("/buscar")
    public List<Anuncio> buscar(@RequestBody Anuncio a){return aService.search(a.getServicio().getNameServicios());}
    ...
    @GetMapping("/buscarmes")
    public List<Anuncio> buscarmes(){return aService.buscarmes();}

    @GetMapping("/cantidadanuncioservicio")
    public List<ResultadoMiriam> buscarserviciosprecio(){return aService.buscarserviciosprecio();}
}
